...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            rv_top_bar = (RelativeLayout) findViewById(com.chivorn.datetimeoptionspicker.R.id.rv_topbar);

            //确定和取消按钮
            btnSubmit = (Button) findViewById(com.chivorn.datetimeoptionspicker.R.id.btnSubmit);
